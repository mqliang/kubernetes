...
CAICLOUD_PREFIXES=(
  "cargo.caicloud.io/caicloudgcr/google_containers"
  "cargo.caicloud.io/caicloudgcr/google-containers"
  "cargo.caicloud.io/caicloudgcr/google_samples"
  "cargo.caicloud.io/caicloudgcr/google-samples"
)
