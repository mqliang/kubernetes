...
```
MASTER_SSH_INFO="vagrant:vagrant@192.168.205.10,vagrant:vagrant@192.168.205.11" NODE_SSH_INFO="vagrant:vagrant@192.168.205.12" KUBERNETES_PROVIDER=caicloud-ansible CAICLOUD_K8S_CFG_STRING_HOST_PROVIDER="vagrant" ./cluster/kube-up.sh
```
...
- Step2:
  ...
  ```
  $ AUTOMATICALLY_INSTALL_ANSIBLE=NO CAICLOUD_K8S_CFG_STRING_KUBE_BASE_VERSION=v1.3.3 CAICLOUD_K8S_CFG_STRING_KUBE_CAICLOUD_VERSION=v0.10.0-e2e KUBERNETES_PROVIDER=caicloud-ansible ./cluster/kube-up.sh
  ```
