...
var map_AliyunPersistentDiskVolumeSource = map[string]string{
	...
	"volumeID":  "Unique name of the PD resource. Used to identify the disk in aliyun",
...
func (AliyunPersistentDiskVolumeSource) SwaggerDoc() map[string]string {
	return map_AliyunPersistentDiskVolumeSource
}

var map_AnchnetPersistentDiskVolumeSource = map[string]string{
	...
	"volumeID":  "Unique name of the PD resource. Used to identify the disk in Anchnet",
	"fsType":    "Required: Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\"",
	"partition": "Optional: Partition on the disk to mount. If omitted, kubelet will attempt to mount the device name. Ex. For /dev/sda1, this field is \"1\", for /dev/sda, this field is 0 or empty.",
	"readOnly":  "Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.",
}

func (AnchnetPersistentDiskVolumeSource) SwaggerDoc() map[string]string {
	return map_AnchnetPersistentDiskVolumeSource
}
...
var map_ContainerStatus = map[string]string{
	...
	"containerID":  "Container's ID in the format 'docker://<container_id>'. More info: http://releases.k8s.io/release-1.4/docs/user-guide/container-environment.md#container-information",
}
...
var map_PersistentVolumeSource = map[string]string{
	...
	"anchnetPersistentDisk": "AnchnetPersistentDisk represents an Anchnet Disk resource that is attached to a kubelet's host machine and then exposed to the pod.",
	"aliyunPersistentDisk":  "AliyunPersistentDisk represents an Aliyun Disk resource that is attached to a kubelet's host machine and then exposed to the pod.",
}
